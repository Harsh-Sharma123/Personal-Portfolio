        ...
        <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="rounded-xl backdrop-blue-md bg-white/10 p-6 hover:shadow-xl hover:shadow-orange-400/30 border border-white/20 transition">
            ...
            <p className="text-white/80 text-xl">
              {" "}
              Proficient in JavaScript, TypeScript, React, Next.js, Node.js,
              Python, PostgreSQLand System Design. Passionate about Software
              Development.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20  hover:shadow-orange-400/30 hover:shadow-xl transition">
            ...
            <p className="text-xl text-white/80">
              {" "}
              I actively solve coding problems and participate in contests to
              ...
              {platforms.map((platform, index) => (
                <>
                  <a
                    ...
                    href={platform.url}
                    target="_blank"
                    className="flex gap-2 hover:cursor-pointer hover:bg-white/20 transition text-white px-3 py-2 bg-white/10 backdrop-blur rounded-xl "
                  >
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 hover:shadow-xl hover:shadow-orange-400/30 p-6 transition">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h4 className="text-2xl font-semibold text-white">Experience</h4>
            </div>
            <p className="text-white/80 text-xl">
              Over 1.5 years of hands-on experience in a Tier-1 tech company.
              Worked on designing and developing data intensive applications and
              backend systems.
            </p>
          </div>
        </div>
