...
export const Navbar = () => {
  ...
  const menuVariants = {
    ...
    return (
        <div className='text-white/70 md:pt-6 sticky top-0 z-50 backdrop-blur bg-black/70'>
            ...
            <div onClick={toggleNav}  className='md:hidden absolute backdrop-blur top-[40px] right-5 border rounded border-white/70 p-2 z-50'>
